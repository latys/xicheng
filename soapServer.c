...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.37 2016-11-03 12:26:44 GMT")
...
{	struct add soap_tmp_add;
	...
	soap_tmp_addResponse.res = &soap_tmp_int;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = add(soap, soap_tmp_add.a, soap_tmp_add.b, soap_tmp_addResponse.res);
	if (soap->error)
		return soap->error;
